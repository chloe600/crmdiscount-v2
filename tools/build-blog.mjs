...
const BLOG_INTRO   = "Platform comparisons, real pricing, and when to buy. Written by RevOps operators whose agency is a certified HubSpot Solutions Partner — paid to right-size the deal, not to grow it.";
...
const topbar = (current) => `<div class="topbar">
  <div class="wrap">
    ...
    <div class="partner-chip">Independent &middot; Not a HubSpot partner</div>
  </div>
</div>`;

const FOOTER = `<footer>
  <div class="wrap">
    <p class="legal">&copy; 2026 CRMdiscount.ai &mdash; an independent buyer-side HubSpot scoping service run by RevOps operators whose agency is a certified HubSpot Solutions Partner &mdash; where a deal qualifies and you choose that agency, delivering your onboarding is paid work for it. We are not HubSpot, Inc., and we are not affiliated with, sponsored by or endorsed by HubSpot, Inc. HubSpot is a registered trademark of HubSpot, Inc. All figures shown are illustrative estimates based on publicly listed rates and do not constitute a quote, an offer, or a guarantee of savings. Only HubSpot, Inc. can price your subscription.</p>
